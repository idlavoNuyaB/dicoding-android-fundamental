...
import com.freisia.consumerapp.adapter.SectionPagerAdapter
import com.freisia.consumerapp.data.model.Users
import com.freisia.consumerapp.ui.favorite.FavoriteActivity
...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onBackPressed() {
        val a = Intent(this.applicationContext, FavoriteActivity::class.java)
    ...
    private fun observe() : Observer<List<Users>>{
        return Observer {
            ...
            fab.setOnClickListener{
                if(!isFavorite){
                    Toast.makeText(this,R.string.favorno,Toast.LENGTH_SHORT).show()
                } else {
                    Toast.makeText(this,R.string.favoryes,Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
